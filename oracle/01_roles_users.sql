...
-- Uprawnienia do logowania i systemowe dla administratora
GRANT CREATE SESSION TO COURIER_ADMIN, COURIER_APP, COURIER_RO, COURIER_REP, COURIER_AUDIT;
GRANT CREATE TABLE, CREATE VIEW, CREATE TRIGGER, CREATE PROCEDURE, CREATE DATABASE LINK, CREATE PUBLIC DATABASE LINK, DROP PUBLIC DATABASE LINK TO COURIER_ADMIN;
GRANT UNLIMITED TABLESPACE TO COURIER_ADMIN;
